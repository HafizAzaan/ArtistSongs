...
public class AddTrackActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String id = intent.getStringExtra(ToDoActivity.ARTIST_ID);
        String name = intent.getStringExtra(ToDoActivity.ARTIST_NAME);
    ...
    private void saveTrack(){
            ...
            if(!TextUtils.isEmpty(trackName)){
                ...
                Toast.makeText(this, "Track title should not be empty", Toast.LENGTH_LONG).show();
            }
        }
}